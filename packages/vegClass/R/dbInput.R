...
#Year, SpeciesPLANTS, TPA, DBH, CrWidth, TcuFT, mcuFT, Bdft, data from the
#FVS_TreeList for the tree records associated with Case ID values specified in
#the treeQuery function arguments. The treeQuery function can be invoked outside
#of main function for testing purposes with the dbGetQuery function of the
#RSQLite R package.
#
#Arguments
#
